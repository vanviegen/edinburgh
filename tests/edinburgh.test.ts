...
test("lazy migration adds a new non-key field", async () => {
    ...
    // Step 2: Deregister V1, register V2 with a new field and a migrate() function
    E.deregisterModel(LazyMigV1);
...
test("runMigration converts rows from old primary key format", async () => {
    ...
    // Step 2: Deregister V1, register V2 with a numeric primary key
    E.deregisterModel(PkConvertV1);
...
test("runMigration populates new secondary indexes", async () => {
    ...
    // Step 2: Deregister V1, register V2 with a new secondary index
    E.deregisterModel(SecPopV1);
...
test("runMigration fixes secondaries affected by migrate()", async () => {
    ...
    // Step 2: Deregister V1, register V2 with a migrate() that changes indexed tag values
    E.deregisterModel(SecMigV1);
...
test("runMigration removes orphaned secondary index entries", async () => {
    ...
    // Step 2: Deregister V1, register V2 without the secondary index
    E.deregisterModel(OrphanV1);
